...
public class Fragment2 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        root = inflater.inflate(R.layout.fragment2_layout, container, false);
        ...
        final ToggleButton toggleButton = root.findViewById(R.id.toggle_graphic);
    ...
    private void addGraphics(LineChart line,
        ...
        line.getLegend().setCustom(new ArrayList<LegendEntry>());
        ...
        chartDataSet_main.setColor(ContextCompat.getColor(getContext(), R.color.colorPrimary));
